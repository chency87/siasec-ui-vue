  ...
  <div class="dashboard-container">
        ...
        <el-table :data="tableData.filter(data => !search || data.name.toLowerCase().includes(search.toLowerCase()))"
          ...
          <el-table-column align="right">
            ...
            <template slot-scope="scope">
              ...
              <el-button size="mini"
                         type='success'
                         @click="handleAccessControl(scope.$index, scope.row)">授权</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-row>
    ...
    <el-dialog title="设备信息管理"
      ...
      <el-tabs v-model="activeName"
        ...
        <el-tab-pane label="数据转发"
                     name="third">
          <transportpanel v-bind:deviceId="selectedDeviceId" />
        </el-tab-pane>
    ...
    <el-dialog title="访问控制规则管理"
               :visible.sync="dialogAccessControlVisible"
               center>
      <accesscontrolpanel v-bind:deviceId="selectedDeviceId" />
    </el-dialog>
...
import AccessControlPanel from './components/accessControl'
import DevicehmiTransportPanel from './components/HmiThirdPanel'
...
export default {
  ...
  components: {
    ...
    transportpanel: DevicehmiTransportPanel
  },
  data() {
    return {
      reFreshDevice: false,
      ...
      dialogAccessControlVisible: false
    }
  },
  ...
  methods: {
    ...
    handleAccessControl(index, row) {
      this.selectedDeviceId = row.id.id
      this.dialogAccessControlVisible = true
      // this.subRuleForm.entityType = 'DEVICE'
      // this.subRuleForm.entityId = row.id
