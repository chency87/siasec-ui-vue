  ...
  <div>
    <div class="app-container">
      ...
      >
        ...
        <el-table-column prop="additionalInfo" label="Desc" width="120"></el-table-column>
        <el-table-column prop="group" label="Group" sortable width="120"></el-table-column>
        <el-table-column prop="status" label="status" width="120"></el-table-column>
        <el-table-column prop="createdTime" label="Creat Time" width="200"></el-table-column>

        <el-table-column fixed="right" label="Option">
          <template slot-scope="scope">
            <el-button @click="handleUpdate" type="text" size="small">编辑</el-button>
            <el-button @click="handleHMI" type="text" size="small">HMI</el-button>
            <el-button @click="handleDelete" type="text" size="small">删除</el-button>
            <el-button @click="dialogFormVisible1 = true" type="text" size="small">授权</el-button>
          </template>
        </el-table-column>
      </el-table>
      ...
      <el-dialog :title="a" :visible.sync="dialogFormVisible">
        ...
        >
          ...
          <el-form-item label="Type:" prop="type">
            <el-select v-model="temp.type" class="filter-item" placeholder="ComboBox">
              <el-option
          ...
          <el-form-item label="Desc:" prop="additionalInfo">
      ...
      <el-dialog title="将设备分配给客户" :visible.sync="dialogFormVisible1">
        <el-form :model="form">
...
<script>
import { getdeviceInfo, addeviceInfo } from "@/api/device";
import {
  fetchList,
  fetchPv,
  createArticle,
  ...
  methods: {
    updatedeviceTable() {
      getdeviceInfo().then((res) => {
        ...
        this.protoPluginInfo.createdTime = res.data[0].createdTime;
    ...
    handleCreate() {
      ...
      formData.append("label", this.temp.label);
      formData.append("additionalInfo", this.temp.additionalInfo);
      addeviceInfo(formData).then((res) => {
        console.log('123');
        console.log(res);
      });
    },
